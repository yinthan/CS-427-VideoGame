...
int main()
{
	...
	//Adding observers
	//subject.addObserver(address of Observer)
	...
	world.init(&renderer, window_width_px, window_height_px);
	...
	while (!world.is_over()) {
        ...
        renderer.updateBackgrounds(elapsed_ms, window_width_px, window_height_px);
