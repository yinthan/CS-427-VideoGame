...
// font_path("arial.tff") -> data/fonts/arial.tff
...
extern unsigned int level_state;

const unsigned int LEVEL_STATE_SELECTOR = 1;
const unsigned int LEVEL_STATE_COMBAT = 2;
